...
const initialCourses: Course[] = [
  { id: "1", code: "1INF27", name: "Algoritmia y Estructura de Datos", credits: 5.00 },
  { id: "2", code: "1INF28", name: "Fundamentos de Sistemas de Información", credits: 3.50 },
  { id: "3", code: "1INF25", name: "Programación 2", credits: 5.00 },
  { id: "4", code: "1INF33", name: "Base de Datos", credits: 5.00 },
  { id: "5", code: "1INF48", name: "Ingeniería de Requisitos", credits: 5.00 },
  { id: "6", code: "1IND90", name: "Empresa y su Entorno", credits: 5.00 },
  { id: "7", code: "1GES92", name: "Taller de Habilidades Interpersonales", credits: 2.50 },
  { id: "8", code: "1EST22", name: "Probabilidad y Estadística", credits: 5.00 },
  { id: "9", code: "1ELE01", name: "Arquitectura de Computadoras", credits: 5.00 },
  { id: "10", code: "1INF29", name: "Sistemas Operativos", credits: 5.00 },
  { id: "11", code: "1INF30", name: "Programación 3", credits: 5.00 },
  { id: "12", code: "1INF31", name: "Arquitectura de Software", credits: 5.00 },
  { id: "13", code: "1INF32", name: "Algoritmos Avanzados", credits: 5.00 },
  { id: "14", code: "1CON27", name: "Contabilidad y Finanzas", credits: 5.00 },
  { id: "15", code: "1EST14", name: "Experimentación Numérica", credits: 5.00 },
  { id: "16", code: "IND231", name: "Ingeniería Económica", credits: 5.00 },
  { id: "17", code: "INF238", name: "Redes de Computadoras", credits: 5.00 },
  { id: "18", code: "1INF50", name: "Diseño de Software", credits: 5.00 },
  { id: "19", code: "1INF24", name: "Inteligencia Artificial", credits: 5.00 },
  { id: "20", code: "1INF34", name: "Modelado y Automatización de Procesos", credits: 5.00 },
  { id: "21", code: "1INF35", name: "Administración de Sistemas Operativos", credits: 5.00 },
  { id: "22", code: "1INF26", name: "Formulación de Proyecto de Fin de Carrera", credits: 5.00 },
  { id: "23", code: "1INF36", name: "Ética y RSU en Ingeniería Informática", credits: 5.00 },
  { id: "24", code: "1INF37", name: "Ingeniería de Software", credits: 5.00 },
  { id: "25", code: "1INF38", name: "Innovación y Emprendimiento con Tecnología", credits: 5.00 },
  { id: "26", code: "1INF39", name: "Gobierno y Gestión de Tecnologías de Información", credits: 5.00 },
  { id: "27", code: "1INF40", name: "Tecnologías de Información para los Negocios", credits: 5.00 },
  { id: "28", code: "1INF41", name: "Seguridad de Información", credits: 5.00 },
]
...
export default function StudyPlanEdit() {
  ...
  const cyclesWithCourses: CycleWithCourses[] = studyPlanCourses.reduce((acc, spc) => {
              ...
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="overflow-x-auto pb-4">
                  <div className="flex space-x-4" style={{ minWidth: "max-content" }}>
                    {cycle.courses.filter(course => course.type === "Obligatorio").map((course, courseIndex) => (
                      <div key={courseIndex} className="bg-gray-200 p-4 rounded-lg w-48 h-48 flex flex-col justify-between flex-shrink-0">
                        <div>
                          <h4 className="text-black font-semibold mb-2 text-sm">{course.name}</h4>
                          <p className="text-xs text-gray-600">{course.code}</p>
                        </div>
                        <p className="text-xs text-gray-600 mt-2">{course.credits.toFixed(2)} créditos</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="overflow-y-auto max-h-[600px]">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {cyclesWithCourses.flatMap(cycle => 
                  cycle.courses.filter(course => course.type === "Electivo").map((course, courseIndex) => (
                    <div key={`${cycle.name}-${courseIndex}`} className="bg-gray-200 p-4  rounded-lg flex flex-col justify-between h-48">
                      <div>
                        <h4 className="text-black font-semibold mb-2 text-sm">{course.name}</h4>
                        <p className="text-xs text-gray-600">{course.code}</p>
                      </div>
