...
import {StudyPlanCourse} from '@/study-plans/interfaces/StudyPlanCourse';
import {SpecialityStudyPlan} from '@/study-plans/interfaces/SpecialityStudyPlan';
...
const useStudyPlanStore = create<StudyPlanStore>((set) => ({
  ...
  addStudyPlan: (studyPlan) => set((state) => ({ studyPlans: [...state.studyPlans, studyPlan] })),
  addStudyPlanCourse: (studyPlanCourse) => set((state) => ({ studyPlanCourses: [...state.studyPlanCourses, studyPlanCourse] })),
  addSpecialityStudyPlan: (specialityStudyPlan) => set((state) => ({ specialityStudyPlans: [...state.specialityStudyPlans, specialityStudyPlan] })),
}));
